...
class MajorsSeeder extends Seeder {
  ...
  _generateMajors() {
    return Array({
      ...
      subjects: new Array(this.subjects[0]._id,this.subjects[1]._id,this.subjects[2]._id,this.subjects[3]._id,this.subjects[4]._id,this.subjects[5]._id,this.subjects[6]._id,this.subjects[7]._id,this.subjects[8]._id)
    },{
      name: "FIA2-II",
      description: "2eme année Formation d'Ingénieur: Informatique Industrielle",
      formation: this.formations[0]._id,
      level: this.levels[1]._id,
      subjects: new Array(this.subjects[18]._id,this.subjects[19]._id,this.subjects[20]._id,this.subjects[21]._id,this.subjects[22]._id,this.subjects[23]._id,this.subjects[24]._id,this.subjects[25]._id)
    })
  }
}
